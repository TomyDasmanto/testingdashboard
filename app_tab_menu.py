...
def build_main_comparison_table_html(
    ...
    for indikator in PDB_MAIN_ROWS:
        ...
        q1_realisasi = _lookup_value(baseline_df, indikator, "out_tw1")
        q2_realisasi = _lookup_value(baseline_df, indikator, "out_tw2")
        cells.append(_format_compare_cell(q1_realisasi, formatter, "value-same"))
        cells.append(_format_compare_cell(q2_realisasi, formatter, "value-same"))
