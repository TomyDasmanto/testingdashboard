...
with top_nominal_tab:
    render_main_comparison_table(
        ...
        formatter=fmt_id0,
        note_text="Baseline mengikuti angka pada Blok Accounting. Shock Fiskal mengikuti baseline dan akan ter-update saat simulasi fiskal diterapkan. Kolom Shock Makro disamakan dengan Shock Fiskal.",
    )
with top_yoy_tab:
    render_main_comparison_table(
        ...
        formatter=fmt_pct,
        note_text="Struktur tabel YoY disamakan dengan Tabel Nominal 2026. Baseline berasal dari growth baseline, Shock Fiskal berasal dari growth setelah simulasi fiskal, dan Shock Makro disamakan dengan Shock Fiskal.",
    )
with top_qtq_tab:
    render_main_comparison_table(
        ...
        formatter=fmt_pct,
        note_text="Struktur tabel QtQ disamakan dengan Tabel Nominal 2026. Baseline berasal dari growth baseline, Shock Fiskal berasal dari growth setelah simulasi fiskal, dan Shock Makro disamakan dengan Shock Fiskal.",
    )
