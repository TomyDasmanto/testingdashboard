...
st.markdown("<div class='section-note'>Angka pada kolom shock yang berbeda dari baseline sekarang diberi warna agar perbedaannya mudah terlihat. Hijau menunjukkan nilai lebih tinggi dari baseline, merah menunjukkan nilai lebih rendah dari baseline.</div>", unsafe_allow_html=True)
...
with top_nominal_tab:
    render_main_comparison_table(
        ...
        formatter=fmt_id0,
        note_text="Kolom Shock Fiskal dan Shock Makro akan diberi warna berbeda jika nilainya berubah terhadap baseline. Ini berlaku untuk setiap kuartal dan full year.",
    )
with top_yoy_tab:
    render_main_comparison_table(
        ...
        formatter=fmt_pct,
        note_text="Tabel YoY memakai pewarnaan yang sama: hijau untuk nilai di atas baseline dan merah untuk nilai di bawah baseline.",
    )
with top_qtq_tab:
    render_main_comparison_table(
        ...
        formatter=fmt_pct,
        note_text="Tabel QtQ juga memakai pewarnaan yang sama agar pergeseran dari baseline mudah terbaca.",
    )
